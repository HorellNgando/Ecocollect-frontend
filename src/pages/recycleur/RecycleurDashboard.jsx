...
const RecycleurDashboard = () => {
  ...
  useEffect(() => {
    console.log('🔄 Initialisation du RecycleurDashboard');
  ...
  return (
    <DashboardLayout title="Tableau de bord" user={{ type: 'recycleur' }}>
      <div className={`p-6 ${getThemeClasses.bgPrimary} min-h-screen`}>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 mb-8">
          <div className={`${getThemeClasses.card} rounded-xl p-4 md:p-6 shadow-lg ${getThemeClasses.border} hover:shadow-xl transition-all hover:-translate-y-1`}>
            <div className="flex items-center justify-between">
              <div className="flex-1">
                <p className={`text-sm ${getThemeClasses.textMuted} mb-1`}>Total demandes</p>
                <p className={`text-2xl md:text-3xl font-bold ${getThemeClasses.textCard}`}>{stats.totalDemandes}</p>
          ...
          <div className={`${getThemeClasses.card} rounded-xl p-4 md:p-6 shadow-lg ${getThemeClasses.border} hover:shadow-xl transition-all hover:-translate-y-1`}>
            <div className="flex items-center justify-between">
              <div className="flex-1">
                <p className={`text-sm ${getThemeClasses.textMuted} mb-1`}>En attente</p>
                <p className={`text-2xl md:text-3xl font-bold ${getThemeClasses.textCard}`}>{stats.demandesEnAttente}</p>
                <div className="flex items-center gap-1 mt-1">
          ...
          <div className={`${getThemeClasses.card} rounded-xl p-4 md:p-6 shadow-lg ${getThemeClasses.border} hover:shadow-xl transition-all hover:-translate-y-1`}>
            <div className="flex items-center justify-between">
              <div className="flex-1">
                <p className={`text-sm ${getThemeClasses.textMuted} mb-1`}>Validées</p>
                <p className={`text-2xl md:text-3xl font-bold ${getThemeClasses.textCard}`}>{stats.demandesValidees}</p>
                <div className="flex items-center gap-1 mt-1">
                  <span className="text-xs text-emerald-600 bg-emerald-50 px-2 py-0.5 rounded-full">
                    Confirmées
                  </span>
          ...
          <div className={`${getThemeClasses.card} rounded-xl p-4 md:p-6 shadow-lg ${getThemeClasses.border} hover:shadow-xl transition-all hover:-translate-y-1`}>
            <div className="flex items-center justify-between">
              <div className="flex-1">
                <p className={`text-sm ${getThemeClasses.textMuted} mb-1`}>Stock total (kg)</p>
                <p className={`text-2xl md:text-3xl font-bold ${getThemeClasses.textCard}`}>{stats.totalStock}</p>
                <div className="flex items-center gap-1 mt-1">
        ...
        {/* Actions rapides */}
        <div className={`${getThemeClasses.card} rounded-xl p-4 md:p-6 shadow-lg ${getThemeClasses.border} mb-8`}>
          <h2 className={`text-lg md:text-xl font-semibold ${getThemeClasses.textCard} mb-4 flex items-center gap-2`}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 ${getThemeClasses.card} rounded-xl p-4 md:p-6 shadow-lg ${getThemeClasses.border}">
            <div className="flex items-center justify-between mb-4">
              <h2 className={`text-lg md:text-xl font-semibold ${getThemeClasses.textCard} flex items-center gap-2`}>
            ...
            <div className="space-y-3 md:space-y-4">
              {recentActivities.map((activity) => {
                ...
                return (
                  <div key={activity.id} className={`flex items-center justify-between p-3 md:p-4 ${getThemeClasses.bgSecondary} rounded-xl hover:${getThemeClasses.bgMuted} transition-colors ${getThemeClasses.border}`}>
                    <div className="flex items-center flex-1 min-w-0">
                      <div className={`p-2 rounded-xl mr-3 md:mr-4 ${getStatusColor(activity.status)} flex-shrink-0 border`}>
                        <Icon className="text-lg md:text-xl" />
                      </div>
                      <div className="min-w-0 flex-1">
                        <p className={`${getThemeClasses.textCard} font-medium text-sm md:text-base truncate`}>{activity.description}</p>
                        <div className="flex items-center gap-2 mt-1">
                          <p className={`text-xs md:text-sm ${getThemeClasses.textMuted}`}>{activity.time}</p>
                          {activity.details && (
                            <>
                              <span className="w-1 h-1 bg-gray-300 rounded-full"></span>
                              <p className={`text-xs md:text-sm ${getThemeClasses.textMuted}`}>{activity.details}</p>
                            </>
                          )}
                        </div>
                      </div>
          ...
          <div className="space-y-6">
            ...
            <div className={`${getThemeClasses.card} rounded-xl p-4 md:p-6 shadow-lg ${getThemeClasses.border}`}>
              <h2 className={`text-lg md:text-xl font-semibold ${getThemeClasses.textCard} mb-4 flex items-center gap-2`}>
            ...
            <div className={`${getThemeClasses.card} rounded-xl p-4 md:p-6 shadow-lg ${getThemeClasses.border}`}>
              ...
              <div className="space-y-3">
                <div className={`flex items-center justify-between p-3 ${getThemeClasses.bgSecondary} rounded-lg`}>
                  <div className="flex items-center gap-2">
                    <span className="text-xl">{getTypeIcon('plastique')}</span>
                    <span className={`font-medium ${getThemeClasses.textCard}`}>Plastique</span>
                  </div>
                  <div className="flex items-center gap-2">
                ...
                <div className={`flex items-center justify-between p-3 ${getThemeClasses.bgSecondary} rounded-lg`}>
                  <div className="flex items-center gap-2">
                    ...
                    <span className={`font-medium ${getThemeClasses.textCard}`}>Papier/Carton</span>
                  </div>
                  <div className="flex items-center gap-2">
                ...
                <div className={`flex items-center justify-between p-3 ${getThemeClasses.bgSecondary} rounded-lg`}>
                  <div className="flex items-center gap-2">
                    ...
                    <span className={`font-medium ${getThemeClasses.textCard}`}>Verre</span>
                  </div>
                  <div className="flex items-center gap-2">
                ...
                <div className={`flex items-center justify-between p-3 ${getThemeClasses.bgSecondary} rounded-lg`}>
                  <div className="flex items-center gap-2">
                    ...
                    <span className={`font-medium ${getThemeClasses.textCard}`}>Métal</span>
                  </div>
                  <div className="flex items-center gap-2">
        ...
        {stats.demandesEnAttente > 0 && (
          <div className={`mt-6 ${getThemeClasses.bgSecondary} ${getThemeClasses.border} rounded-xl p-4`}>
